...
namespace ProductsInStore.Controllers
{
    ...
    public class SalesController : Controller
    {
        ...
        {
            return _dbContext.Sales.OrderBy(s => true).OrderBy(item => item.DateSold).Include(s => s.CustomerNavigation).Include(s => s.ProductNavigation).Include(s => s.StoreNavigation).ToList();
